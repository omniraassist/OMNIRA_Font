      ...
      <div className="container">
        ...
        <div className="ben-grid">
          <div className="glass ben-card reveal reveal-d1" style={{ borderRadius: 'var(--r-xl)' }}>
            ...
            <span className="ben-emoji">📅</span>
            <div className="ben-metric">+42%</div>
          ...
          <div className="glass ben-card reveal reveal-d3" style={{ borderRadius: 'var(--r-xl)' }}>
            <div className="ben-card-glow" />
            <span className="ben-emoji">⚡</span>
            <div className="ben-metric">8h</div>
          ...
          <div className="glass ben-card reveal reveal-d4" style={{ borderRadius: 'var(--r-xl)' }}>
            <div className="ben-card-glow" />
            <span className="ben-emoji">💎</span>
            <div className="ben-metric">4.9★</div>
        ...
        <div className="testi-grid">
          <div className="glass testi-card reveal reveal-d1" style={{ borderRadius: 'var(--r-xl)' }}>
          ...
          <div className="glass testi-card reveal reveal-d2" style={{ borderRadius: 'var(--r-xl)' }}>
            <div className="testi-stars">
              <i className="fa-solid fa-star" />
              <i className="fa-solid fa-star" />
              <i className="fa-solid fa-star" />
          ...
          <div className="glass testi-card reveal reveal-d3" style={{ borderRadius: 'var(--r-xl)' }}>
            <div className="testi-stars">
              <i className="fa-solid fa-star" />
              <i className="fa-solid fa-star" />
              <i className="fa-solid fa-star" />
