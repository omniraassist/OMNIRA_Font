      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className="section-header reveal">
          ...
          <p>
            ...
            <strong style={{ color: '#fff' }}>30% de sus clientes potenciales</strong> por no responder a tiempo en
            WhatsApp.
          </p>
        </div>
        ...
        <div className="pain-grid">
          ...
          <div className="glass pain-card reveal reveal-d3" style={{ borderRadius: 'var(--r-xl)' }}>
            ...
            <div>
              ...
              <p>
                Responder siempre lo mismo — horarios, precios, disponibilidad — te roba horas que deberías dedicar a tus
                clientes.
              </p>
            </div>
          </div>
        ...
        <div className="glass-em stats-row reveal" style={{ borderRadius: 'var(--r-xl)' }}>
