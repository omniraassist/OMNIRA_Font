        ...
        <div className="panel-plan-inner">
          <div className="panel-plan-hero reveal visible">
            ...
            <p className="panel-plan-lead">
              Tras elegir tu paquete, seguirás al <strong>pago seguro</strong> y al asistente de
              configuración: <strong>Meta Business</strong> (WhatsApp Cloud API) y, si lo necesitas,{' '}
              <strong>Twilio</strong> para mensajería y verificación.
            </p>
          </div>
          ...
          <div className="container panel-plan-cards-wrap">
            <div className="plans-grid panel-plan-cards-grid">
              {plansByCheapest.map((plan) => {
                ...
                const cardClass = ['plan-card', 'plan-card-selectable', plan.featured ? 'featured' : '', isSel ? 'is-selected' : '']
                  .filter(Boolean)
                  .join(' ');
                return (
                  <button
            ...
            {selected ? (
              <>
                ...
                <strong className="panel-plan-sticky-plan">
                  {selected.name} · €{selected.priceNum}{selected.period}
                </strong>
              </>
            ) : (
              <>
