...
export function Forgot() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (!resetToken) throw new Error('Introduce el código que recibiste por correo.');
              ...
              <div className="auth-card">
                ...
                <form onSubmit={onSubmit} translate="no" className="notranslate">
                  {step === 'verify' ? (
                    ...
                    <>
                      <div className="form-group">
                        <label className="form-label" htmlFor="resetCode">Código recibido por correo</label>
                        <input
                          className="form-input"
                          type="text"
                          id="resetCode"
                ...
                {step === 'reset' && (
                  <p className="auth-switch">
                    <button
                      type="button"
                      onClick={() => { setStep('verify'); setOk(''); setErr(''); }}
